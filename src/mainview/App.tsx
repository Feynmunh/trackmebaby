...
function App() {
  ...
  useEffect(() => {
    ...
    const updateTheme = () => {
      const theme =
        (localStorage.getItem("trackmebaby-theme") as Theme) || "system";
    ...
    const handleSystemChange = () => {
      const currentTheme = localStorage.getItem("trackmebaby-theme") as Theme;
          ...
          <div className="flex flex-row flex-1 overflow-hidden text-app-text-main">
            ...
            <div className="flex flex-row flex-1 overflow-hidden relative">
              ...
              <div className="flex-1 overflow-y-auto relative">
                ...
                {activeTab === "ai" && <AITab screenContext={screenContext} />}
                ...
                >
                  ...
                  <div className="flex flex-col flex-1 overflow-hidden bg-app-bg">
                    ...
                    <div className="flex-1 overflow-hidden">
                      <AITab screenContext={screenContext} isSidebar />
                    </div>
                  </div>
                </div>
              )}
