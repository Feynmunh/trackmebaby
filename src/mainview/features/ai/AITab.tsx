...
import type { AIQueryOptions, ChatMessage } from "../../../shared/types.ts";

const logger = createLogger("ai-tab");

// Try to import RPC, fallback for dev/build
let queryAIFn:
    | ((question: string, options?: AIQueryOptions) => Promise<string>)
    | null = null;
try {
...
export default function AITab() {
    ...
    return (
        <div className="h-full flex flex-col relative overflow-hidden bg-app-bg font-sans">
            {/* --- Content Area --- */}
            <div className="relative z-10 flex-1 flex flex-col items-center pt-24">
                ...
                >
                    <h1 className="text-4xl md:text-6xl text-app-text-main leading-tight font-playfair tracking-normal">
                        How can I{" "}
                        <span className="italic font-playfair">help</span> you?
                    </h1>
                    <p className="mt-6 text-[15px] text-app-text-muted max-w-xl mx-auto leading-relaxed">
                ...
                <div
                    className={`w-full max-w-4xl mx-auto flex-1 flex flex-col transition-all duration-700 ${hasMessages ? "mt-0 rounded-none border-none bg-transparent shadow-none" : "mt-16 bg-app-surface/40 backdrop-blur-2xl border-t border-x border-app-border rounded-t-[2.5rem] shadow-2xl relative px-6 py-6"}`}
                >
                            ...
                            <div className="space-y-6 max-w-3xl mx-auto w-full pb-32">
                                ...
                                {loading && (
                                    <div className="flex justify-start">
                                        <div className="bg-app-surface-elevated rounded-3xl rounded-bl-md px-6 py-5 shadow-sm border border-app-border">
                                            <div className="flex gap-2">
                                                <div
                                                    className="w-2 h-2 rounded-full bg-app-text-muted animate-bounce"
                                                    style={{
                                                        animationDelay: "0ms",
                                                    }}
                                                />
                    ...
                    >
                        ...
                        >
                            <div className="bg-app-surface-elevated rounded-2xl shadow-sm border border-app-border p-4">
                                <input
                                    ref={inputRef}
                                    type="text"
                                    value={input}
                                    ...
                                    disabled={loading}
                                    className="w-full bg-transparent border-none outline-none text-app-text-main placeholder-app-text-muted font-medium text-[15px] mb-3 px-1"
                                />
                                ...
                                <div className="flex items-center justify-between pt-1">
                                    <div className="flex items-center gap-4 text-app-text-muted">
                                        <button
                                            type="button"
                                            className="hover:text-app-text-main transition-colors p-1"
                                        >
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <button
                                            ...
                                            className="w-8 h-8 rounded-full bg-app-accent hover:opacity-90 disabled:opacity-50 flex items-center justify-center text-white transition-colors shadow-md shadow-app-accent/20"
                                        >
                                            <ArrowUp
                                                className="w-4 h-4"
                                                strokeWidth={3}
