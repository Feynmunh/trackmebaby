...
export default function InsightCard({
    ...
    return (
        <div
            className={`bg-mac-surface/40 border border-mac-border rounded-xl shadow-mac-sm p-3 transition-opacity duration-200 ${isDismissing ? "opacity-0" : "opacity-100"}`}
        >
            <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mb-1.5 flex-wrap">
                        <h3 className="font-semibold text-sm truncate max-w-[70%] text-mac-text">
                            {insight.title}
                        </h3>
                        <span
                    ...
                    {/* Body */}
                    <p className="text-mac-text-secondary text-sm leading-relaxed mb-3">
                        {insight.description}
                    </p>
            ...
            {/* Action Buttons Row */}
            <div className="flex items-center gap-2 mt-2 pt-2 border-t border-mac-border/40">
                {onApprove && (
                    <button
