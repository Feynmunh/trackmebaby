            ...
            <div className="px-4 py-4">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        <div className="w-9 h-9 rounded-lg flex items-center justify-center bg-app-bg">
                            <svg
                            ...
                            {githubAuthenticated ? (
                                <>
                                    ...
                                    <p className="text-[12px] text-app-text-muted">
                                        Issues and pull requests are visible in
                                        dashboards
                                    </p>
                                </>
                            ) : (
                    ...
                    {githubAuthenticated ? (
                        ...
                        <button
                            ...
                            className="px-4 py-1.5 rounded-lg text-[13px] font-medium transition-all active:scale-[0.98] bg-app-bg hover:bg-app-hover text-app-text-main disabled:opacity-40"
                        >
                            {githubLoading ? (
