...
} from "../../features/projects/ActivityChart.tsx";
        ...
        return (
            <div className="space-y-5">
                ...
                {(() => {
                    ...
                    return (
                        <div className="bg-transparent rounded-xl border border-app-border p-4 relative overflow-visible">
                            {/* Bar rows */}
                                ...
                                {barRows.map((row) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <button
                                                onClick={row.onClick}
                                                className="w-[68px] text-right text-[10px] font-semibold uppercase tracking-widest text-app-text-muted hover:text-orange-400 active:text-orange-500 transition-colors shrink-0 leading-none"
                                            >
                                                {row.label}
                                            </button>
                                            {/* Bar track */}
                                            <div className="flex-1 h-[13px] rounded-sm overflow-hidden bg-app-hover">
                                                {row.loading ? (
                                                    <div className="h-full w-1/3 bg-app-border/40 rounded animate-pulse" />
                                                ) : row.needsAuth ? (
                                            ...
                                            {/* Numeric value */}
                                            <span className="text-[11px] font-bold text-app-text-main w-6 text-right shrink-0 tabular-nums">
                                                {row.loading ? (
