...
export function ToastProvider({ children }: { children: ReactNode }) {
    ...
    const timeouts = useRef<Map<string, Timer>>(new Map());
                    ...
                    {toasts.map((toast, index) => {
                        ...
                        return (
                            <motion.div
                                ...
                                className="pointer-events-auto px-6 py-2.5 border border-app-border bg-app-surface-elevated shadow-app-lg backdrop-blur-xl rounded-full font-mono text-[10px] font-black uppercase tracking-[0.2em] flex items-center gap-3 text-app-text-main min-w-[120px] justify-center"
                            >
